import cenipolis from "../src/assets/images/cenipolis-hp.png";
import vrott from "../src/assets/images/vrott-hp.png";
import gogoCinema from "../src/assets/images/gogo-cinema.png";
import revivify from "../src/assets/images/revivify.png";

const logotext = "HARSHAL";
const meta = {
  title: "Harshal Mahajan",
  description:
    "I’m Harshal Mahajan Senior devloper,currently working in Mumbai",
};

const introdata = {
  title: "I’m Harshal Mahajan",
  animated: {
    first: "I love programming",
    second: "I code complex backends",
